module parameters
  ...
  real(PR), parameter:: IO_freqTime = 5.e-1  ! (this is the default way to dump output files; put a positive number to use)
  ...
  integer,  parameter :: lf = 1536 !768 ! Number of cell in the x direction
  integer,  parameter :: nf = 256  !128 ! Number of cell in the y direction

  ! Set the baseline lf0 and nf0 for the dt reduction
  integer,  parameter :: lf0 = 768 ! Number of cell in the x direction
  integer,  parameter :: nf0 = 128 !
  
  ! IC, BC and domain setup
  integer, parameter  :: IC_type = RMI
  real(PR), parameter :: tmax = 2.0
  integer, parameter  :: nmax = 1000000000    ! put a large number if want to finish based on tmax only
  real(16), parameter :: Lx_16 = 6.           ! Length of the domain in the x-direction
  real(16), parameter :: Ly_16 = 1.           ! Length of the domain in the y-direction
  integer, parameter  :: BC_type = RMI_BC     ! Boundary conditions
