module parameters
  ...
  character(100) :: file_slice_x = 'output/Results/Lax/order3.dat'
  ...
  real(16), parameter :: l_16 = 3*(2./200)!/ell
  ...
  integer, parameter  :: IC_type = lax
  real(PR), parameter :: tmax = 0.26
  real(16), parameter :: Lx_16 = 2. !Lenght of the domain in the x-direction
  real(16), parameter :: Ly_16 = 2./Lx_16  !Lenght of the domain in the y-direction
