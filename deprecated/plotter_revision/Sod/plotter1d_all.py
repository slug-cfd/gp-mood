...
dataName1 = 'shuosher1d_GP3rd_1quad_RK3_nodtRed_cfl0.8_HLLC_256_final_100329.dat'
...
gp3_rk3_noDt = data1d(dataName1) # in use
gp5_rk4_noDt = data1d(dataName2) # in use
gp5_rk4_Dt   = data1d(dataName3) # not in use
gp7_rk4_noDt = data1d(dataName4) # in use
gp7_rk4_Dt   = data1d(dataName5) # not in use

pol3  = data1d(dataName6) # in use
