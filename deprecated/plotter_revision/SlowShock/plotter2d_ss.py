...
baseName = 'SS2d_gp5_2quad_RK4_cfl0p8_hllc_256x256'; dataNumb = '100212'
...
ax2.plot(xi[0:-1],d2.rho[128,:],'m', linewidth=0.5) #, marker='x', linewidth=0.5, markersize=3.)
ax2.plot(xi[0:-1],d2.ordr[128,:],'b', linewidth=0.5) # marker='o', linewidth=0.5, markersize=3.)
