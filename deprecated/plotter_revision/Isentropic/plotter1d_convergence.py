...
gp3_2_L1 = np.array([gp1.L1, gp2.L1, gp3.L1, gp4.L1]) #, gp5.L1]
...
gp5_3_L1 = np.array([gp11.L1, gp12.L1, gp13.L1, gp14.L1]) #, gp20.L1]
...
gp7_4_L1 = np.array([gp21.L1, gp22.L1, gp23.L1, gp24.L1]) #, gp29.L1] #, gp30.L1]


# convert data to log10 scale
gridsLog    = np.log10(grids)
gp3_2_L1 = np.log10(gp3_2_L1)
gp5_3_L1 = np.log10(gp5_3_L1)
gp7_4_L1 = np.log10(gp7_4_L1)
...
ax2.plot(gridsLog, gp3_2_L1, 'r', marker='^',linestyle = 'None', markersize=1.5)
ax2.plot(gridsLog, gp5_3_L1, 'g', marker='s',linestyle = 'None', markersize=1.5)
ax2.plot(gridsLog, gp7_4_L1, 'b', marker='>',linestyle = 'None', markersize=1.5)

ax2.plot(gridsLog, -np.log10(grids**3)+5.3, '--r', linewidth=0.5)
ax2.plot(gridsLog, -np.log10(grids**5)+8.2, '--g', linewidth=0.5)
ax2.plot(gridsLog, -np.log10(grids**7)+11.6, '--b', linewidth=0.5)
...
plt.legend([r'3rd-order GP-MOOD, $R=1$', r'5th-order GP-MOOD, $R=2$', r'7th-order GP-MOOD, $R=3$'], fontsize = 4)
plt.tight_layout()
plt.grid()
