...
class data1d:
    ...
    def __init__(self, file_name):  # 'self' means the class itself.
        ...
        self.y   = self.raw[1]      # second column would be the density
        self.L1  = self.raw[2]     # mx
        self.inv = self.raw[3]     # mx



# now, we can load the data by calling the class that I defined,
dataName1 = 'isen_GP3rd_2quad_RK3_cfl0.8_HLLC_Lx20_050_ell_1.0_cross_error.dat'
dataName2 = 'isen_GP3rd_2quad_RK3_cfl0.8_HLLC_Lx20_100_ell_1.0_cross_error.dat'
dataName3 = 'isen_GP3rd_2quad_RK3_cfl0.8_HLLC_Lx20_200_ell_1.0_cross_error.dat'
dataName4 = 'isen_GP3rd_2quad_RK3_cfl0.8_HLLC_Lx20_400_ell_1.0_cross_error.dat'



dataName11 = 'isen_GP5th_3quad_RK4_dtRed_cfl0.8_HLLC_Lx20_050_ell_1.0_cross_error.dat'
dataName12 = 'isen_GP5th_3quad_RK4_dtRed_cfl0.8_HLLC_Lx20_100_ell_1.0_cross_error.dat'
dataName13 = 'isen_GP5th_3quad_RK4_dtRed_cfl0.8_HLLC_Lx20_200_ell_1.0_cross_error.dat'
dataName14 = 'isen_GP5th_3quad_RK4_dtRed_cfl0.8_HLLC_Lx20_400_ell_1.0_cross_error.dat'



dataName21 = 'isen_GP7th_4quad_RK4_dtRed_cfl0.8_HLLC_Lx20_050_ell_1.0_cross_error.dat'
dataName22 = 'isen_GP7th_4quad_RK4_dtRed_cfl0.8_HLLC_Lx20_100_ell_1.0_cross_error.dat'
dataName23 = 'isen_GP7th_4quad_RK4_dtRed_cfl0.8_HLLC_Lx20_200_ell_1.0_cross_error.dat'
dataName24 = 'isen_GP7th_4quad_RK4_dtRed_cfl0.8_HLLC_Lx20_400_ell_1.0_cross_error.dat'


dataName25 = 'pol-mood3_2quad_RK3_cfl0p5_HLLC_Lx20_050_error.dat'
dataName26 = 'pol-mood3_2quad_RK3_cfl0p5_HLLC_Lx20_100_error.dat'
dataName27 = 'pol-mood3_2quad_RK3_cfl0p5_HLLC_Lx20_200_error.dat'
dataName28 = 'pol-mood3_2quad_RK3_cfl0p5_HLLC_Lx20_400_error.dat'


plotName = 'isentropic_conv_cross.png'
...
# poly 3rd order + 2 quad + RK3
pol1 = data1d(dataName25)
pol2 = data1d(dataName26)
pol3 = data1d(dataName27)
pol4 = data1d(dataName28)
#gp25 = data1d(dataName25)

pol3_2_L1_org = np.array([pol1.L1, pol2.L1, pol3.L1, pol4.L1]) #, gp5.L1]
...
pol3_2_L1 = np.log10(pol3_2_L1_org)
