module parameters
  ...
  character(100) :: file='./plotter/Mach800/DblMach1600_GP7th_4quad_RK4_cfl0.8_HLLC_600_'
  ...
  real(PR), parameter:: IO_freqTime = 1.25e-4 ! (this is the default way to dump output files; put a positive number to use)
