  ...
  character(100) :: file='./plotter/Sedov/stabTests/sedov_GPMOOD3_1quad_RK3_cfl0.85_hllc_400_'
  character(100) :: file_slice_x = './plotter/Sedov/slice_x.dat'

  real(PR), parameter :: CFL  =  0.85
  ...
  real(PR), parameter:: IO_freqTime = -0.01 ! (this is the default way to dump output files; put a positive number to use)
