module parameters
  ...
  character(100) :: file='output/Results/DMR/o3_pol/'
  ...
  ! Space integration
  integer,  parameter :: space_method   = pol_MOOD
  ...
  real(16), parameter :: l_16 = 12*(4./800)
  ...
  integer, parameter  :: IC_type = DMR
  real(PR), parameter :: tmax = 0.25
  real(16), parameter :: Lx_16 = 4. !Lenght of the domain in the x-direction
