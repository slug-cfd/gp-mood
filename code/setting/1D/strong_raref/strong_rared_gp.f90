module parameters
  ...
  character(100) :: file_slice_x = 'output/Results/strong_raref/order3.dat'
  ...
  integer, parameter  :: IC_type = strong_raref
  real(PR), parameter :: tmax = 0.15
