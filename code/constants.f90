module constants
  ...
  !BC indices
  integer, parameter :: Neumann =17, Periodic =18, Dirichlet =19, Reflective =20, Mach800_BC = 201
  !IC indices
  ...
  integer, parameter ::   RP_2D_6   =38, sedov = 39, M3WT = 40, KH = 41, isentropic_vortex = 42
  integer, parameter ::   sod_rotated= 43, Shu_Osher_rotated=44, Mach800 = 45
