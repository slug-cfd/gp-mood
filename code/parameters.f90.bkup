module parameters
  ...
  character(100) :: file='./plotter/Isentropic/isen_GP3rd_2quad_RK3_cfl0.8_HLLC_Lx20_100_ell_1.0_'
  ...
  integer,  parameter :: nf = 100  ! Number of cell in the y direction


  ! IC, BC and domain setup
  integer, parameter  :: IC_type = isentropic_vortex
  real(PR), parameter :: tmax = 20.
  integer, parameter  :: nmax = 1000000000 ! put a large number if want to finish based on tmax only
  real(16), parameter :: Lx_16 = 20. !Lenght of the domain in the x-direction
  real(16), parameter :: Ly_16 = 20. !Lenght of the domain in the y-direction
