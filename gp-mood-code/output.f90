...
contains
   ...
   subroutine write_output(fileNumb)
      ...
      call h5dcreate_f(file_id, "ordr_priori", H5T_NATIVE_INTEGER, dataspace_id, dataset_id, status)
      call h5dwrite_f(dataset_id, H5T_NATIVE_INTEGER, CellGPO_priori(1:lf, 1:nf), dims, status)
      call h5dclose_f(dataset_id, status)
   ...
   subroutine write_diagnostic()
      ...
      call h5dclose_f(dataset_id, status)
      call h5dcreate_f(file_id, "pct_detected_cell_a_priori", H5T_NATIVE_REAL, dataspace_id, dataset_id, status)
      call h5dwrite_f(dataset_id, H5T_NATIVE_REAL, pct_detected_cell_a_priori(iter_0:size), dims, status)
      call h5dclose_f(dataset_id, status)
      call h5dcreate_f(file_id, "pct_detected_cell_a_posteriori", H5T_NATIVE_REAL, dataspace_id, dataset_id, status)
      call h5dwrite_f(dataset_id, H5T_NATIVE_REAL, pct_detected_cell_a_posteriori(iter_0:size), dims, status)
      call h5dclose_f(dataset_id, status)
