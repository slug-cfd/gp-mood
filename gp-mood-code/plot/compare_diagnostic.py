...
plt.plot(time_NN_GP_MOOD[window_size:], run_avg[window_size:], color='red', label='NN-GP-MOOD (averaged over 10 runs)')
#plt.plot(time_NN_GP_MOOD[window_size:], run_avg_priori[window_size:], color='blue', label='NN-GP-MOOD, a priori (averaged over 10 runs)')
