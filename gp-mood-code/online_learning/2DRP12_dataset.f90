module parameters
   ...
   integer, parameter :: dataset_size = 300000 ! Leave at one for running simu / high number for generating dataset
   ...
   integer, parameter  :: problem = RP_2D_12
   real(PR), parameter :: tmax = 0.25
   integer, parameter  :: nmax = 37 ! put a large number if want to finish based on tmax only
