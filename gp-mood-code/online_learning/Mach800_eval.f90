module parameters
   ...
   character(100) :: restart_filename='output_Mach800_GP_MOOD_CFL_0.8_256_256_100125.h5'
   ...
   character(100) :: NN_filename='model_Mach800_256_first_10%_CEL_dropout_0.1_0_20'
