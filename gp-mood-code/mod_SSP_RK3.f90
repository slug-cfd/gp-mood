...
contains
   ...
   subroutine SSP_RK3_(Uin, Uout)
      ...
      count_detected_cell = count_detected_cell 
      count_detected_cell_a_posteriori = count_detected_cell_a_posteriori 
      count_detected_cell_a_priori = count_detected_cell_a_priori 
